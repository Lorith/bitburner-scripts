...
import { pctColor, PrintTable, DefaultStyle, ColorPrint } from '/downloaded/tables.js'
...
export async function GetSymbolAssociations(ns, servers) {
	...
	if (data.length == 0) {
		...
		await ns.wget('https://raw.githubusercontent.com/danielyxie/bitburner/master/archive/src/Locations/data/LocationNames.ts', 'locations.txt');;
		await ns.wget('https://raw.githubusercontent.com/danielyxie/bitburner/master/archive/src/StockMarket/data/StockSymbols.ts', 'stocksymbols.txt');
